    ...
    <div id="sec_product" class="pt-16 pb-16 mx-auto container px-4">
        ...
        <div class="space-y-6">
                ...
                <div class="p-6 md:px-10 md:py-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4 text-center md:text-left">
                    <div class="md:flex-1 md:pr-6">
                        <div class="flex items-center justify-center md:justify-start gap-3">
                            <svg viewBox="0 0 120 120" aria-hidden="true" class="w-9 h-9 text-white flex-shrink-0">
                                <g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round">
                                    <path d="M60 12C80 12 98 30 98 52C98 78 82 96 60 106C38 96 22 78 22 52C22 30 40 12 60 12Z" stroke-width="6" />
                                    <path d="M26 72C39 52 48 54 60 91C72 54 81 52 94 72" stroke-width="13" />
                                </g>
                                <g fill="currentColor">
                                    <circle cx="60" cy="12" r="9" /><circle cx="92" cy="32" r="9" />
                                    <circle cx="94" cy="72" r="9" /><circle cx="60" cy="106" r="9" />
                                    <circle cx="26" cy="72" r="9" /><circle cx="28" cy="32" r="9" />
                                </g>
                            </svg>
                            <h3 class="text-2xl md:text-3xl font-black text-white">Vibsync</h3>
                        </div>
            ...
            <div class="bg-gradient-to-br from-[#0f172a] to-[#1e3a5f] rounded-2xl shadow-lg overflow-hidden">
                <div class="p-6 md:px-10 md:py-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4 text-center md:text-left">
                    <div class="md:flex-1 md:pr-6">
                        <img src="/images/localrag_logo.png" alt="LocalRAG" class="h-9 md:h-10 mx-auto md:mx-0" />
                    ...
                    <div class="flex flex-col items-center md:items-end gap-3 md:flex-shrink-0">
                        <div class="flex flex-wrap justify-center md:justify-end gap-2">
                            <span class="px-3 py-1 bg-yellow-400 text-blue-900 text-xs font-bold rounded-full">Free</span>
                            <span class="px-3 py-1 bg-blue-500 text-white text-xs font-medium rounded-full">iOS</span>
                            <span class="px-3 py-1 bg-blue-500 text-white text-xs font-medium rounded-full">Android</span>
                            <span class="px-3 py-1 bg-blue-500 text-white text-xs font-medium rounded-full">Claude AI</span>
                            <span class="px-3 py-1 bg-blue-500 text-white text-xs font-medium rounded-full">9 Formats</span>
                        </div>
                        <a href="https://localrag.app" target="_blank" class="inline-block px-6 py-2 bg-yellow-400 text-blue-900 font-bold rounded-lg hover:bg-yellow-300 transition duration-200 whitespace-nowrap">
                            localrag.app
                        </a>
                    </div>
                </div>
