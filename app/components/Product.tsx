...
export function Product() {
  return (
    <div id="sec_product" class="pt-12 pb-12 mx-auto">
        ...
        <div class="place-self-auto bg-auto bg-no-repeat bg-center bg-[#19585b] bg-[url('/images/ai-sebas_logo.png')] mx-2 overflow-hidden border rounded-lg shadow-2xl">
            ...
            <div class="p-4 text-gray-300 text-center sm:p-6 lg:p-8">
                ...
                <span class="mt-2 block text-xl">Start from JPY1,100/mon</span>
                </h2>
                ...
                <p class="mt-8 text-xl font-medium text-gray-300">
                    <a href="https://www.aisebas.com/" target="_blank" class="hover:underline">https://aisebas.com/</a>
                </p>
            </div>
        </div>
