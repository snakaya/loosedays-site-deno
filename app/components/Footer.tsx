      ...
      <div class="max-w-screen-lg mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div class="flex flex-col items-center md:items-start">
            ...
            <p class="mt-3 text-sm text-gray-500 dark:text-gray-400 text-center md:text-left">
              IT Consulting, Architecture, and Product Development based in
              Tokyo.
            </p>
          </div>
          ...
          {/* Column 2: Navigation */}
          <div class="flex flex-col items-center md:items-start">
            <p class="text-sm font-bold mb-3 uppercase tracking-wide">
              Navigation
            </p>
            <div class="flex flex-col gap-1.5 text-sm text-center md:text-left">
              <a
                href="#sec_product"
                class="text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition duration-200"
              >
                Products
              </a>
              <a
          ...
          <div class="flex flex-col items-center md:items-start">
            ...
            <div class="flex items-center gap-3 mb-4">
              <a
                href="https://github.com/snakaya/"
                target="_blank"
                class="p-2 rounded-full transition duration-200 hover:opacity-60"
                aria-label="GitHub"
              >
                <SiGithub class="w-5 h-5" />
              </a>
              <a
                href="https://x.com/lsdys"
                target="_blank"
                class="p-2 rounded-full transition duration-200 hover:opacity-60"
                aria-label="X"
              >
              ...
              <a
                href="https://youtube.com/@loosedaysjp"
                target="_blank"
                class="p-2 rounded-full transition duration-200 hover:opacity-60"
                aria-label="YouTube"
              >
            ...
            <div class="flex flex-col gap-2">
              <a
                href="https://openid.net/foundation/sponsoring-members/"
                target="_blank"
                class="flex items-center gap-2 hover:opacity-80 transition duration-200"
              >
                <img
            ...
            <div class="flex items-center gap-2 mt-3">
              <a
                ...
                class="inline-flex items-center gap-1.5 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200 transition duration-200"
                aria-label="Deno"
              >
                <SiDeno class="w-6 h-6" />
        ...
        <div class="mt-10 pt-6 border-t border-gray-200 dark:border-gray-600 text-center">
          <p class="text-xs text-gray-400">
            Copyright &copy; 2023-2026 LOOSEDAYS Co.,Ltd. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
